...
<section class="mbr-gallery mbr-slider-carousel cid-rRF176nNHj" id="gallery1-3">
    ...
    <div class="container">
        <div><!-- Filter --><!-- Gallery --><div class="mbr-gallery-row"><div class="mbr-gallery-layout-default"><div><div><div class="mbr-gallery-item mbr-gallery-item--p1" data-video-url="false" data-tags="酷毙"><div href="#lb-gallery1-3" data-slide-to="0" data-toggle="modal"><img src="{{asset('assets/images/background1.jpg')}}" alt="" title=""><span class="icon-focus"></span><span class="mbr-gallery-title mbr-fonts-style display-7">这里输入标题</span></div></div><div class="mbr-gallery-item mbr-gallery-item--p1" data-video-url="false" data-tags="响应式"><div href="#lb-gallery1-3" data-slide-to="1" data-toggle="modal"><img src="{{asset('assets/images/background2.jpg')}}" alt="" title=""><span class="icon-focus"></span><span class="mbr-gallery-title mbr-fonts-style display-7">这里输入标题</span></div></div><div class="mbr-gallery-item mbr-gallery-item--p1" data-video-url="false" data-tags="创意"><div href="#lb-gallery1-3" data-slide-to="2" data-toggle="modal"><img src="{{asset('assets/images/background3.jpg')}}" alt="" title=""><span class="icon-focus"></span><span class="mbr-gallery-title mbr-fonts-style display-7">这里输入标题</span></div></div><div class="mbr-gallery-item mbr-gallery-item--p1" data-video-url="false" data-tags="动画"><div href="#lb-gallery1-3" data-slide-to="3" data-toggle="modal"><img src="{{asset('assets/images/background4.jpg')}}" alt="" title=""><span class="icon-focus"></span><span class="mbr-gallery-title mbr-fonts-style display-7">这里输入标题</span></div></div><div class="mbr-gallery-item mbr-gallery-item--p1" data-video-url="false" data-tags="酷毙"><div href="#lb-gallery1-3" data-slide-to="4" data-toggle="modal"><img src="{{asset('assets/images/background5.jpg')}}" alt="" title=""><span class="icon-focus"></span><span class="mbr-gallery-title mbr-fonts-style display-7">这里输入标题</span></div></div><div class="mbr-gallery-item mbr-gallery-item--p1" data-video-url="false" data-tags="酷毙"><div href="#lb-gallery1-3" data-slide-to="5" data-toggle="modal"><img src="{{asset('assets/images/background6.jpg')}}" alt="" title=""><span class="icon-focus"></span><span class="mbr-gallery-title mbr-fonts-style display-7">这里输入标题</span></div></div><div class="mbr-gallery-item mbr-gallery-item--p1" data-video-url="false" data-tags="响应式"><div href="#lb-gallery1-3" data-slide-to="6" data-toggle="modal"><img src="{{asset('assets/images/background7.jpg')}}" alt="" title=""><span class="icon-focus"></span><span class="mbr-gallery-title mbr-fonts-style display-7">这里输入标题</span></div></div><div class="mbr-gallery-item mbr-gallery-item--p1" data-video-url="false" data-tags="动画"><div href="#lb-gallery1-3" data-slide-to="7" data-toggle="modal"><img src="{{asset('assets/images/background8.jpg')}}" alt="" title=""><span class="icon-focus"></span><span class="mbr-gallery-title mbr-fonts-style display-7">这里输入标题</span></div></div></div></div><div class="clearfix"></div></div></div><!-- Lightbox --><div data-app-prevent-settings="" class="mbr-slider modal fade carousel slide" tabindex="-1" data-keyboard="true" data-interval="false" id="lb-gallery1-3"><div class="modal-dialog"><div class="modal-content"><div class="modal-body"><div class="carousel-inner"><div class="carousel-item active"><img src="{{asset('assets/images/background1.jpg')}}" alt="" title=""></div><div class="carousel-item"><img src="{{asset('assets/images/background2.jpg')}}" alt="" title=""></div><div class="carousel-item"><img src="{{asset('assets/images/background3.jpg')}}" alt="" title=""></div><div class="carousel-item"><img src="{{asset('assets/images/background4.jpg')}}" alt="" title=""></div><div class="carousel-item"><img src="{{asset('assets/images/background5.jpg')}}" alt="" title=""></div><div class="carousel-item"><img src="{{asset('assets/images/background6.jpg')}}" alt="" title=""></div><div class="carousel-item"><img src="{{asset('assets/images/background7.jpg')}}" alt="" title=""></div><div class="carousel-item"><img src="{{asset('assets/images/background8.jpg')}}" alt="" title=""></div></div><a class="carousel-control carousel-control-prev" role="button" data-slide="prev" href="#lb-gallery1-3"><span class="mbri-left mbr-iconfont" aria-hidden="true"></span><span class="sr-only">Previous</span></a><a class="carousel-control carousel-control-next" role="button" data-slide="next" href="#lb-gallery1-3"><span class="mbri-right mbr-iconfont" aria-hidden="true"></span><span class="sr-only">Next</span></a><a class="close" href="#" role="button" data-dismiss="modal"><span class="sr-only">Close</span></a></div></div></div></div></div>
    </div>
